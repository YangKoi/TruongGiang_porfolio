/* ==========================================================================
   LANGUAGE DATA (i18n) — Vietnamese & English
   ========================================================================== */
const i18n = {
    vi: {
        nav: {
        ...
        profile: {
            ...
            subtitle: "Kỹ sư Tự động hóa & Đo lường Dầu khí",
            location: "Vũng Tàu / TP. Hồ Chí Minh, Việt Nam",
            status: "Sẵn sàng hợp tác",
            about: "Tôi là một Kỹ sư Điện, Tự động hóa & Đo lường (E&I) với hơn 5 năm kinh nghiệm chuyên sâu trong ngành Dầu khí (Oil & Gas). Lĩnh vực hoạt động cốt lõi của tôi bao gồm thiết kế, hiệu chuẩn, vận hành thử các <strong>Hệ thống Đo lường Khí Thương mại (Custody Transfer Metering Skids)</strong>, lập trình hệ điều khiển PLC/SCADA và đánh giá sai số đo lường theo tiêu chuẩn quốc tế như AGA, API và ISO.",
            emailLabel: "Email liên hệ",
            phoneLabel: "Số điện thoại"
        },
        stats: {
            years: "Năm kinh nghiệm",
            projects: "Dự án trạm đo khí",
            accuracy: "Chuẩn xác & An toàn"
        },
        pillars: {
            heading: "Lĩnh Vực Hoạt Động Cốt Lõi",
            p1Title: "Gas Metering Systems (Hệ thống Đo khí Thương mại)",
            p1Desc: "Đảm bảo đo lường dòng chảy áp lực cao đạt độ chính xác khắt khe nhất để bàn giao thương mại liên doanh và quốc tế.",
            p2Title: "Metrological Calibration & Assessment (Kiểm định & Hiệu chuẩn)",
            p2Desc: "Hiệu chuẩn toàn diện từ cảm biến đo đạc (Transmitters) đến máy tính lưu lượng (Flow Computers), kiểm tra và phân tích sai số không chắc chắn (Uncertainty Analysis).",
            p3Title: "Industrial Control (PLC & SCADA)",
            p3Desc: "Phát triển các thuật toán điều khiển tin cậy cao, kiến trúc dự phòng kép nóng (Redundancy) trên hệ thống SCADA phòng điều khiển."
        },
        skills: {
            sectionTag: "Năng lực Kỹ thuật",
            heading: "Kỹ Năng & Công Nghệ Chuyên Ngành",
            subtitle: "Sự kết hợp giữa chuyên môn đo lường vật lý chính xác cao và lập trình hệ thống điều khiển công nghiệp hiện đại.",
            cat1: "Đo lường & Hiệu chuẩn",
            cat2: "Hệ thống Điều khiển",
            cat3: "Tiêu chuẩn & Đánh giá"
        },
        experience: {
            sectionTag: "Hành trình Sự nghiệp",
            heading: "Kinh Nghiệm Làm Việc & Học Vấn",
            subtitle: "Dòng thời gian ghi nhận các cột mốc cống hiến thực tế tại các dự án trọng điểm công nghiệp khí.",
            job1Title: "Kỹ sư Điện & Tự động hóa chính (Senior E&I Engineer)",
            job1Company: "PV GAS / PTSC Metrology & Automation Center",
            job1Desc: "Tổ chức và chịu trách nhiệm kỹ thuật chính trong việc hiệu chuẩn, kiểm tra đo lường định kỳ cho các hệ thống Custody Transfer Metering Skid của trạm phân phối khí, giàn khai thác dầu khí biển. Thực hiện tính toán và phân tích sai số hệ thống khí hóa lỏng LNG phục vụ xuất nhập hàng thương mại. Thiết kế nâng cấp hệ điều khiển PLC dự phòng và giao diện SCADA trung tâm.",
            job2Title: "Chuyên viên Đo lường & Thiết bị (Instrumentation Specialist)",
            job2Company: "Vietsovpetro / PTSC Offshore Projects",
            job2Desc: "Lắp đặt, chạy thử và kiểm định định kỳ các thiết bị cảm biến truyền tín hiệu đo (Transmitters) dòng chảy, áp suất, chênh áp và nhiệt độ. Trực tiếp hiệu chuẩn máy tính lưu lượng Flow Computer Daniel và Omni, cấu hình bảng thông số khí và thành phần sắc ký khí online. Xử lý các sự cố sai lệch phép đo dòng chảy tại các giàn công nghệ trung tâm biển.",
            job3Title: "Kỹ sư Tự động hóa (Automation Engineer)",
            job3Company: "Viet Nam Industrial Automation Co., Ltd",
            job3Desc: "Thiết kế bản vẽ tủ điện điều khiển lực & điều khiển. Lập trình PLC Siemens S7-300, S7-1200 và màn hình HMI giám sát hệ thống. Thực hiện công tác chạy thử (commissioning) tại các nhà máy, cấu hình mạng truyền thông công nghiệp Modbus RTU và Profibus.",
            eduTitle: "Bằng cấp & Chứng chỉ Quốc tế / Quốc gia",
            edu1: "Bằng Kỹ sư Kỹ thuật Điều khiển & Tự động hóa",
            edu1Org: "Trường Đại học Bách Khoa - ĐHQG TP. Hồ Chí Minh",
            edu2: "Chứng chỉ Hiệu chuẩn & Đánh giá thiết bị Đo lường (Khí & Chất lỏng)",
            edu2Org: "Trung tâm Kỹ thuật Tiêu chuẩn Đo lường Chất lượng 3 (QUATEST 3)",
            edu3: "Chứng chỉ Vận hành & Cấu hình Flow Computer Daniel & OMNI",
            edu3Org: "Emerson Process Management / OMNI Flow Computers Inc. Academy",
            edu4: "Chứng chỉ An toàn Dầu khí Biển Quốc tế (BOSIET)",
            edu4Org: "Tiêu chuẩn OPITO quốc tế",
    ...
    en: {
        ...
        profile: {
            ...
            subtitle: "Automation & Oil & Gas Metering Engineer",
            location: "Vung Tau / Ho Chi Minh City, Vietnam",
            status: "Open to Collaboration",
            about: "I am an Electrical, Automation & Instrumentation (E&I) Engineer with over 5 years of specialized experience in the Oil & Gas industry. My core expertise includes designing, calibrating, and commissioning <strong>Custody Transfer Gas Metering Systems</strong>, programming PLC/SCADA control systems, and performing measurement uncertainty assessments per international standards including AGA, API, and ISO.",
            emailLabel: "Contact Email",
            phoneLabel: "Phone Number"
        },
        stats: {
            years: "Years of Experience",
            projects: "Gas Metering Projects",
            accuracy: "Precision & Safety"
        },
        pillars: {
            heading: "Core Areas of Expertise",
            p1Title: "Gas Metering Systems (Custody Transfer)",
            p1Desc: "Ensuring high-pressure flow measurement achieves the strictest accuracy requirements for commercial handover in joint ventures and international projects.",
            p2Title: "Metrological Calibration & Assessment",
            p2Desc: "Comprehensive calibration from measurement transmitters to Flow Computers, including uncertainty analysis and metrology audit reporting.",
            p3Title: "Industrial Control (PLC & SCADA)",
            p3Desc: "Developing high-reliability control algorithms and hot-standby redundancy architectures on central SCADA systems."
        },
        skills: {
            sectionTag: "Technical Competencies",
            heading: "Skills & Specialized Technologies",
            subtitle: "A blend of high-precision physical metrology expertise and modern industrial control system programming.",
            cat1: "Measurement & Calibration",
            cat2: "Control Systems",
            cat3: "Standards & Assessment"
        },
        experience: {
            sectionTag: "Career Journey",
            heading: "Work Experience & Education",
            subtitle: "A timeline of milestones and contributions at key oil & gas industrial projects.",
            job1Title: "Senior E&I Engineer (Automation & Metrology)",
            job1Company: "PV GAS / PTSC Metrology & Automation Center",
            job1Desc: "Led technical responsibility for periodic calibration and verification of Custody Transfer Metering Skid systems at gas distribution stations and offshore platforms. Conducted measurement uncertainty analysis for LNG commercial handover. Designed PLC redundancy upgrades and central SCADA interfaces.",
            job2Title: "Instrumentation Specialist",
            job2Company: "Vietsovpetro / PTSC Offshore Projects",
            job2Desc: "Installed, commissioned, and periodically verified flow, pressure, differential pressure, and temperature transmitters. Directly calibrated Daniel and Omni Flow Computers, configured gas property tables and online gas chromatograph compositions. Troubleshot flow measurement deviations at central processing platforms.",
            job3Title: "Automation Engineer",
            job3Company: "Viet Nam Industrial Automation Co., Ltd",
            job3Desc: "Designed power and control panel drawings. Programmed Siemens S7-300, S7-1200 PLCs and HMI interfaces. Performed factory commissioning and configured Modbus RTU and Profibus industrial networks.",
            eduTitle: "Degrees & International / National Certificates",
            edu1: "Bachelor of Engineering – Control & Automation Engineering",
            edu1Org: "Ho Chi Minh City University of Technology (HCMUT) – VNU",
            edu2: "Calibration & Assessment Certificate for Measurement Instruments (Gas & Liquid)",
            edu2Org: "Technical Center for Standards, Metrology & Quality No. 3 (QUATEST 3)",
            edu3: "Flow Computer Operation & Configuration Certificate – Daniel & OMNI",
            edu3Org: "Emerson Process Management / OMNI Flow Computers Inc. Academy",
            edu4: "Basic Offshore Safety Induction & Emergency Training (BOSIET)",
            edu4Org: "OPITO International Standard",
...
/* ==========================================================================
   PROJECTS DATA STORE — Bilingual (vi + en)
   ========================================================================== */
const projectsData = {
    "project-1": {
        vi: {
...
function applyLanguage(lang) {
    ...
    if (langBtn) {
        ...
        langBtn.setAttribute("title", lang === "vi" ? "Switch to English" : "Chuyển sang Tiếng Việt");
    }
    ...
    // MODAL loading text — update if visible
    const modalLoading = document.querySelector(".modal-loading");
    if (modalLoading) modalLoading.textContent = t.modal.loading;
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    projectCards.forEach(card => {
        card.addEventListener("click", () => {
            ...
            if (data) {
                loadProjectDetails(data[currentLang]);
    ...
    const closeModal = () => {
        ...
        modalContent.innerHTML = `<div class="modal-loading">${t.modal.loading}</div>`;
    };
    ...
    function goToSlide(index) {
        ...
        carouselSlides.forEach((slide, i) => slide.classList.toggle("active", i === activeCarouselIndex));
        carouselDots.forEach((dot, i) => dot.classList.toggle("active", i === activeCarouselIndex));
    }
    ...
    if (contactForm) {
        contactForm.addEventListener("submit", (e) => {
            e.preventDefault();
            alert(i18n[currentLang].contact.successMsg);
        });
    }
});
